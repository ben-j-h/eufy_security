...
class PropertyToEntityDescription(Enum):
    ...
    open = EntityDescription(id=auto(), device_class=BinarySensorDeviceClass.DOOR)
    lastOpenedByName = EntityDescription(id=auto(), category=EntityCategory.DIAGNOSTIC)
    lastOpenedByType = EntityDescription(id=auto(), category=EntityCategory.DIAGNOSTIC)
    timesOpened = EntityDescription(id=auto(), category=EntityCategory.DIAGNOSTIC)
